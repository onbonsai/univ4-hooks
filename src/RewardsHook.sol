 ...
 * @title RewardsHook
 * @author @c0rv0s
 * @notice Mints you $POINTS whenever you buy. Mints you $NEGATIVEPOINTS when you sell. $POINTS and $NEGATIVEPOINTS are paired in a pool together.
 */
contract RewardsHook is BaseHook {
