...
contract Config {
    ...
    IERC20 constant token1 = IERC20(address(0xf4587227797CC95CeB057dA02f87eB19284BEaC3)); // COFFEE
    ...
    IHooks constant hookContract = IHooks(address(0x56464A8f627495cf7FDBd57Ef8dC5A853d14C080)); 
